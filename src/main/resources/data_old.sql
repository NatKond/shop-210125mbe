...
VALUES
    ...
    (2, 1, 35.99, 39.99, NOW(), NOW(), 'Heavy-duty pruning shears for trimming bushes and small branches', 'https://example.com/images/pruning_shears.jpg', 'Pruning Shears'),
    ...
    (4, 3, 699.99, 849.99, NOW(), NOW(), 'Gas-powered lawn mower with 21-inch cutting deck', 'https://example.com/images/lawn_mower.jpg', 'New Gas Lawn Mower');
